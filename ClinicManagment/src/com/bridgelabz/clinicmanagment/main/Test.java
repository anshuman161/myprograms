...
static Date date;
	...
	{ 
		...
		ArrayList<DoctorDetails> ald = new ArrayList<DoctorDetails>();
		ArrayList<PatientDetails> alp = new ArrayList<PatientDetails>();
		int c=0;
       ...
       int choice=scan.nextInt();		
		...
		switch (choice) 
		{
			...
			case 5:
					...
					ArrayList<DoctorDetails> doclist=find.FindById(ald, did);
					if(doclist!=null)
					{
						if(doclist.size()>=1)
						{
			...
			case 7:
					...
					do
					{
						...
						case 2:
								...
								ald=find.FindByName(ald,dname);
								System.out.println(ald);			
								break;
						case 3:
								//search doctor by Availability
								System.out.println("Enter Docotor Availability");
								long avail=scan.nextLong();
								ald=find.FindByavailability(ald, avail);
								System.out.println(ald);
								break;
						case 4:
								System.exit(0);
